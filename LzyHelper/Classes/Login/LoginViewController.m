...
@property(strong, nonatomic)UIButton *showPassBtn;/*显示密码按钮*/
@property(strong, nonatomic)UIView *mainView;/*存放各个部件的View*/
@property(strong, nonatomic)UIButton *bottomBtn;/*底部的主操作按钮*/

@property(strong, nonatomic)UIImageView *topImageView;/*顶部的图片*/
@property(strong, nonatomic)UITextField *mobileField;/*手机号*/
@property(strong, nonatomic)UITextField *mobileCodeField;/*验证码*/
@end
...
-(UIScrollView *)myScrollView{
    if (!_myScrollView) {
        _myScrollView = ({
            ...
            scrollView.showsHorizontalScrollIndicator = _myScrollView.showsVerticalScrollIndicator = NO;
...
-(UIView *)mainView{
    if (!_mainView) {
        _mainView = ({
            ...
            view.frame = (CGRect){{0,0}, {kScreen_Width, 300}};
