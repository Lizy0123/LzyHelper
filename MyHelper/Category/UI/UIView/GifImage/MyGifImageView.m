...
@interface MyGifImageView ()

@property (nonatomic, strong) MyGifImage *animatedImage;
...
- (void)setImage:(UIImage *)image
{
    ...
    if ([image isKindOfClass:[MyGifImage class]] && image.images) {
        if([image.images[0] isKindOfClass:UIImage.class])
            [super setImage:image.images[0]];
        else
            [super setImage:nil];
        self.currentFrame = nil;
        self.animatedImage = (MyGifImage *)image;
...
- (void)setAnimatedImage:(MyGifImage *)animatedImage
{
