...
-(void)defaultStyle{
    ...
    [self setTitleColor:kColorMain forState:UIControlStateHighlighted];
...
-(void)successStyle{
    ...
    [self setBackgroundImage:[self buttonImageFromColor:kColorMain] forState:UIControlStateNormal];
