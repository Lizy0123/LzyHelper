...
#import "MyGuideView.h"
#import "HcdGuideViewCell.h"

@interface MyGuideView()<UICollectionViewDelegate, UICollectionViewDataSource, UIScrollViewDelegate>
...
@implementation MyGuideView

+ (instancetype)sharedInstance {
    static MyGuideView *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [MyGuideView new];
    });
    return instance;
}
